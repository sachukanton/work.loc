...
return [
    ...
    'required'             => 'Поле ":attribute" повинно мати непорожнє значення.',
    'required_if'          => 'Поле ":attribute" повинно мати непорожнє значення, якщо поле ":other" дорівнює :value.',
    'required_unless'      => 'Поле ":attribute" повинно мати непорожнє значення, якщо поле ":other" не дорівнює :value.',
