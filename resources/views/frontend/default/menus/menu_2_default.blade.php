<div class="uk-position-relative">
    <ul {{ $_item->style_id ? "id=\"{$_item->style_id}\"" : NULL }} class="uk-nav uk-navbar-nav uk-nav-category-default uk-flex-center uk-flex-wrap {{ $_item->style_class }}">
        @foreach($_item->menu_items as $_menu_item)
            @include('frontend.default.menus.menu_2_default_item', ['_item' => $_menu_item])
        @endforeach
    </ul>
