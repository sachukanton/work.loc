        ...
        <table
            ...
            <tbody>
                <?php $__currentLoopData = $_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <tr class="<?php echo e($_classes[$_item->status] ?? 'order-status-1'); ?>">
                        <td>
                            <?php echo e("#{$_item->id}"); ?>
                        ...
                        <?php if($_authUser->hasAllPermissions('shop_orders_read')): ?>
                            <td class="uk-text-center">
...
<?php /**PATH /var/www/test09/data/www/test09.ukrmisto.com/resources/views/backend/shop/partials/items_new_orders.blade.php ENDPATH**/ ?>