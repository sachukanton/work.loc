    ...
    <ul <?php echo e($_item->style_id ? "id=\"{$_item->style_id}\"" : NULL); ?>>
        <?php $__currentLoopData = $_item->menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('frontend.default.menus.menu_item', ['_item' => $_menu_item], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/test09/data/www/test09.ukrmisto.com/resources/views/frontend/default/menus/menu.blade.php ENDPATH**/ ?>